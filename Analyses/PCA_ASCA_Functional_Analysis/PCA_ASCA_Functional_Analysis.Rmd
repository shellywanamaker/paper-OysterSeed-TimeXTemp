...
capture.output(ASCA.GetSummary(ASCA), file = "../../Data/ASCA_model_summary.txt")
```
...
capture.output(perm.test, file = "../../Data/ASCA_permTest_summary.txt")
```
...
pdf(file="../../Figures/MainText/Figure4.pdf", width=10, height=12)
...
write.csv(time_ASCA_PC1_2_loadings_GO, "../../Data/TableS5.csv", quote = FALSE, row.names = FALSE)
...
pdf(file="../../Figures/MainText/Figure6.pdf", width=8, height=10)
...
write.csv(temp_ASCA_PC1_loadings_GO, "../../Data/TableS6.csv", quote = FALSE, row.names = FALSE)
...
write.csv(PC_loadings_GO, "../../Data/TableS3.csv", quote = FALSE, row.names = FALSE)
